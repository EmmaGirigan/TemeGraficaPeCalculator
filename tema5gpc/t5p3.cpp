...
public:
    void patrat(double lungime, int nivel, CPunct& p, CVector v)
    {
        ...
        {
            patrat(lungime / 2.0, nivel - 1, p, v);
            p1 = v.getDest(p, lungime / 2.0);
            v.rotatie(60);
            patrat(lungime / 2.0, nivel - 1, p1, v);
            p1 = v.getDest(p1, lungime / 2.0);
            v.rotatie(-120);
            patrat(lungime / 2.0, nivel - 1, p1, v);
            p1 = v.getDest(p1, lungime / 2.0);
            v.rotatie(60);
            patrat(lungime / 2.0, nivel - 2, p1, v);
        }
    }
    ...
    void afisare(double lungime, int nivel)
    {
        ...
        patrat(lungime, nivel, p1, v1);
        patrat(lungime, nivel, p2, v2);
        patrat(lungime, nivel, p3, v3);
    }
};
